        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start" >
          ...
          >
            ...
            >
              ...
              <div className="space-y-2" >
                ...
                <p className="flex items-center gap-2" >
                  <span className="w-2 h-2 bg-lime-400 rounded-full" ></span>
                  <span className="text-lime-400 font-semibold" >Admin:</span> admin@campusconnect.com
                </p>
              </div>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={loading}
              className="w-full bg-lime-400 py-4 rounded-xl text-black font-semibold hover:bg-lime-300 hover:shadow-medium transition-modern shadow-subtle text-base hover:shadow-lime-400/25 disabled:opacity-50 disabled:cursor-not-allowed" 
            >
