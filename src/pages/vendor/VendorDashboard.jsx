    ...
    <>
      ...
      <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 pt-8 relative min-h-screen z-10" overflow-y-auto>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16" overflow-y-auto
        >
        ...
        >
          <h2 className="text-xl font-semibold text-white" overflow-y-auto>Quick Actions</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6" overflow-y-auto>
              ...
              >
                {action.to ? (
                  ...
                  <button
                    ...
                    className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] hover:from-[#252525] hover:to-[#2a2a2a] transition-modern border border-neutral-800/50 p-6 rounded-xl text-center block group hover:shadow-medium hover:shadow-lime-400/10 w-full" overflow-y-auto
                  >
                    <div className="flex flex-col items-center space-y-3" overflow-y-auto>
                      <div className="p-3 bg-lime-400/10 rounded-xl group-hover:bg-lime-400/20 transition-colors" overflow-y-auto>
                        {action.icon}
        ...
        >
          <div className="flex justify-between items-center mb-8" overflow-y-auto>
            <h2 className="text-2xl font-semibold text-white" overflow-y-auto>My Services</h2>
            <motion.button
              onClick={handleAddService}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-lime-400 text-black font-semibold py-3 px-6 rounded-xl hover:bg-lime-300 transition-modern shadow-medium hover:shadow-lime-400/25 flex items-center gap-2" overflow-y-auto
            >
        ...
        >
          <div className="flex justify-between items-center mb-8" overflow-y-auto>
            <h2 className="text-2xl font-semibold text-white" overflow-y-auto>Recent Bookings</h2>
            <Link
              to="/vendor/bookings"
              className="text-lime-400 hover:text-lime-300 transition-colors font-medium" overflow-y-auto
            >
              View All →
            </Link>
          </div>
          ...
          >
            <div className="p-6 border-b border-neutral-800/50" overflow-y-auto>
              <h3 className="text-lg font-semibold text-white" overflow-y-auto>Latest Bookings</h3>
            </div>
            ...
            {bookings.length === 0 && (
              <div className="text-center py-16" overflow-y-auto>
                ...
                <h3 className="text-gray-300 text-xl font-semibold mb-2" overflow-y-auto>No bookings yet</h3>
                <p className="text-gray-500 text-base max-w-md mx-auto leading-relaxed" overflow-y-auto>
