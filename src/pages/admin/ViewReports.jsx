    ...
    <>
      ...
      <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 pt-8 relative min-h-screen z-10" overflow-y-auto>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12" overflow-y-auto
        >
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] p-6 rounded-xl border border-neutral-800/50 shadow-medium" overflow-y-auto>
            <div className="flex items-center justify-between mb-3" overflow-y-auto>
              <div className="p-2 bg-green-400/10 rounded-lg" overflow-y-auto>
            ...
            <h2 className="text-2xl font-bold text-white" overflow-y-auto>${totalRevenue}</h2>
          </div>

          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] p-6 rounded-xl border border-neutral-800/50 shadow-medium" overflow-y-auto>
            <div className="flex items-center justify-between mb-3" overflow-y-auto>
              <div className="p-2 bg-blue-400/10 rounded-lg" overflow-y-auto>
            ...
            <h2 className="text-2xl font-bold text-white" overflow-y-auto>{bookings.filter(b => b.status === 'completed').length}</h2>
          </div>

          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] p-6 rounded-xl border border-neutral-800/50 shadow-medium" overflow-y-auto>
            <div className="flex items-center justify-between mb-3" overflow-y-auto>
              <div className="p-2 bg-purple-400/10 rounded-lg" overflow-y-auto>
            ...
            <p className="text-gray-400 text-sm font-medium mb-1" overflow-y-auto>Active Services</p>
            <h2 className="text-2xl font-bold text-white" overflow-y-auto>{services.length}</h2>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] p-6 rounded-xl border border-neutral-800/50 shadow-medium" overflow-y-auto>
            ...
            <p className="text-gray-400 text-sm font-medium mb-1" overflow-y-auto>Pending Bookings</p>
            <h2 className="text-2xl font-bold text-white" overflow-y-auto>{bookings.filter(b => b.status === 'pending').length}</h2>
          </div>
        </motion.div>

        {/* Charts Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12" overflow-y-auto>
          {/* Monthly Revenue Chart */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] border border-neutral-800/50 rounded-xl p-6 shadow-strong" overflow-y-auto
          >
            <h3 className="text-xl font-semibold text-white mb-6" overflow-y-auto>Monthly Revenue</h3>
            <div className="space-y-4" overflow-y-auto>
              {monthlyData.map((data, index) => (
                <div key={data.month} className="flex items-center justify-between" overflow-y-auto>
                  <span className="text-gray-400 text-sm w-12" overflow-y-auto>{data.month}</span>
                  <div className="flex-1 mx-4" overflow-y-auto>
                    <div className="bg-neutral-700 rounded-full h-2" overflow-y-auto>
                      <motion.div
                        initial={{ width: 0 }}
                  ...
                  <span className="text-white text-sm font-medium" overflow-y-auto>${data.revenue}</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] border border-neutral-800/50 rounded-xl p-6 shadow-strong" overflow-y-auto
          >
            <h3 className="text-xl font-semibold text-white mb-6" overflow-y-auto>Popular Services</h3>
            <div className="space-y-4" overflow-y-auto>
              {popularServices.slice(0, 5).map((service, index) => (
                <div key={service.id} className="flex items-center justify-between" overflow-y-auto>
                  <div className="flex items-center" overflow-y-auto>
                    <div className="w-8 h-8 bg-lime-400/10 rounded-lg flex items-center justify-center mr-3" overflow-y-auto>
                      <span className="text-lime-400 text-xs font-bold" overflow-y-auto>{index + 1}</span>
                    </div>
                    <span className="text-white text-sm font-medium" overflow-y-auto>{service.name}</span>
                  </div>
                  <span className="text-gray-400 text-sm" overflow-y-auto>{service.bookings} bookings</span>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] border border-neutral-800/50 rounded-xl overflow-hidden shadow-strong" overflow-y-auto
        >
          <div className="p-6 border-b border-neutral-800/50" overflow-y-auto>
            <h3 className="text-xl font-semibold text-white" overflow-y-auto>Recent Activity</h3>
          </div>

          <div className="divide-y divide-neutral-800/50" overflow-y-auto>
            {bookings.slice(0, 5).map((booking, index) => (
              <motion.div
                ...
                className="p-6 flex items-center justify-between hover:bg-neutral-900/30 transition-colors" overflow-y-auto
              >
                <div className="flex items-center" overflow-y-auto>
                  ...
                  <div>
                    <p className="text-white font-medium" overflow-y-auto>{booking.service}</p>
                    <p className="text-gray-400 text-sm" overflow-y-auto>Booked by {booking.vendor || 'Student'} • {booking.date}</p>
                  </div>
                </div>
